...
class IntergrationLidarWidget extends TaggingStatefulWidget {

  IntergrationLidarWidget( eTags taggingTag ) : super( taggingTag:taggingTag);

  @override
  TaggingWidgetState<IntergrationLidarWidget> createState() =>  _IntergrationLidarWidgetState(taggingMetaProperty);

}

class _IntergrationLidarWidgetState extends TaggingWidgetState<IntergrationLidarWidget> {

  _IntergrationLidarWidgetState(metaProperty taggingMetaProperty) : super(taggingMetaProperty);

  @override
  Widget build(BuildContext context) {
    final UIColors uiColors = Theme.of(context).extension<UIColors>()!;

    return GetBuilder<IntegrationLidarController>(
        tag: tag,
        builder: (IntegrationLidarController controller) {
          ...
          return Stack(
            children: [
              ...
              Positioned(
                ...
                top: 0,
                bottom: 0,
                child: ImageCanvasConsumeWidget(controller,tag ,is_active_scale: false),
              ),
